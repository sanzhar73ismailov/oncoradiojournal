<?php
//if (!isset($_GET["qweasd11!"])) { exit ("Ooops"); }
...
echo '</table>';
echo '<br>Просмотреть последние <br/>&emsp;&emsp;<a href=?col=100>100</a> <a href=?col=500>500</a>';
echo '<br/>&emsp;&emsp;<a href=?col=1000>1000</a> посещений.';
