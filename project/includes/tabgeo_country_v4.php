...
if(md5_file(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'tabgeo_country_v4.dat') <> $db_md5){
    $db_content = file_get_contents('http://tabgeo.com/api/v4/country/db/get/');
    if($db_md5 == md5($db_content)){
        file_put_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'tabgeo_country_v4.dat', $db_content);
    }
}
